package com.blogspot.nerdydevel;
...
public class AppLock {
        ...
        /** The lock_stream. */
        static FileOutputStream lock_stream = null;
        ...
        public static boolean setLock(String key) {
                ...
                try {
                        ...
                        instance = null;
                        Logger.getLogger(AppLock.class.getName()).log(Level.SEVERE, "Fail to set AppLock", ex);
                        // edited by jiajiechen
                        try {
							lock_stream.close();
						} catch (IOException e) {
							e.printStackTrace();
